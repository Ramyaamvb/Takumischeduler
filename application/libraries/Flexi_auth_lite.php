...
class Flexi_auth_lite
{
	...
	{
		return (bool) (isset($this->CI->auth->session_data[$this->CI->auth->session_name['user_identifier']]) && $this->CI->auth->session_data[$this->CI->auth->session_name['user_identifier']]);
	}
	...
	{
		return (bool) (isset($this->CI->auth->session_data[$this->CI->auth->session_name['logged_in_via_password']]) && $this->CI->auth->session_data[$this->CI->auth->session_name['logged_in_via_password']]);
	}
	...
	{
		return (bool) (isset($this->CI->auth->session_data[$this->CI->auth->session_name['is_admin']]) && $this->CI->auth->session_data[$this->CI->auth->session_name['is_admin']]);
	}
