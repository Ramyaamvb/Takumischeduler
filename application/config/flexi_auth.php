...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['columns']['old_csid'] = 'uacc_old_csid';
...
/*    $config['database']['custom']['user_profile']['table'] = 'user_profiles';
    ...
    $config['database']['custom']['user_profile']['custom_columns'] = array(
        'upro_first_name','upro_last_name','upro_email_preferred','upro_receive_emails',
        'upro_receive_sms', 'upro_date_of_birth', 'upro_gender', 'upro_membership_type', 
        'upro_student_id', 'upro_home_address', 'upro_home_phone', 'upro_mobile_phone',
        'upro_ice_name', 'upro_ice_relationship', 'upro_ice_number', 'upro_course_dept', 'upro_home_country', 'upro_study_duration', 'upro_current_year', 'upro_share_email_union', 'upro_last_confirmed'
    );
*/
	###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###
	...
	*/ 
	...
	$config['database']['user_sess']['join'] = 'usess_uacc_fk';
...
/**
	...
	*/
	$config['security']['login_session_expire'] = 86400*30;
	...
	*/
	$config['security']['user_cookie_expire'] = 60*60*24*30;
	...
	*/ 
	$config['security']['valid_password_chars'] = '\s\S'; //'\.\,\-_ a-z0-9';
	...
	*/
	$config['security']['static_salt'] = 'cgX8dDfavVp09aYkSTm!';
	...
	*/
	$config['security']['expire_forgotten_password'] = 2880; // 2 days
	...
	*/
	$config['security']['login_attempt_time_ban'] = 60*3; // 3 minutes
...
$config['email']['site_title'] = "Takumi Mado";
...
//$config['email']['from_email'] = "";
	...
	/*
	* ADDITIONAL CUSTOM SMTP SETTINGS
	*/


    $config['email']['protocol'] = 'smtp';
    $config['email']['mailpath'] = '';
    $config['email']['smtp_host'] = 'smtp.reg365.net';
    $config['email']['smtp_user'] = 'noreply@takumimado.com';
    $config['email']['smtp_pass'] = 'fKK4RDLh83GD';
	...
	*/
	...
	$config['email']['email_template_forgot_old_password'] = 'forgot_old_password.tpl.php';
