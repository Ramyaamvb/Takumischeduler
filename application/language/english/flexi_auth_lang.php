...
$lang['activation_email_successful'] 	 			= '<h4 class="text-center">An activation email has been sent to the email address you just provided.<br>&nbsp;</h4>';
$lang['activation_email_unsuccessful']  	 		= 'Unable to send activation email.';
$lang['account_requires_activation'] 				= '<h2 class="text-center"><u><i>You must confirm your account by clicking the link emailed to you before you can join any Club or Society!</i></u></h2><h3>&nbsp;<br>If you don\'t receive this email shortly, please check your spam folder or visit the login help/support page</h3>';
